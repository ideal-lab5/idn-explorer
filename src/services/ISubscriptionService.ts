...
export interface ISubscriptionService {
   ...
   */
  pauseSubscription(signer: any, subscriptionId: string): Promise<void>;
   ...
   */
  killSubscription(signer: any, subscriptionId: string): Promise<void>;
   ...
   */
  updateSubscription(signer: any, params: UpdateSubscriptionParams): Promise<void>;
   ...
   */
  reactivateSubscription(signer: any, subscriptionId: string): Promise<void>;
   ...
   */
  calculateSubscriptionFees(amount: number): Promise<number>;
